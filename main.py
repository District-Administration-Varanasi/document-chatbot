...
class ChatBot():
  ...
  template = """
  You are a Government of India Employee. Ypu  will be asked questions about various services and poslicies. Use following piece of context to answer the question. 
